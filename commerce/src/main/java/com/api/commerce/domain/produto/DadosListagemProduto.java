...
public record DadosListagemProduto(String id, String name, int quantity, double price, String color, String size, String discount, String description, String category_id
		//, List<String> imagem
		) {
